...
export interface PanelRegistrySlice {
  ...
  createPanel(scope: SidebarScope, entityId: string, data: Omit<SidebarPanel, "id">): SidebarPanel;
...
export const createPanelRegistrySlice: StateCreator<PanelRegistrySlice> = (set, get) => ({
  definitions: {
    global: {},
    note: {},
    dashboard: {},
