...
import { useNoteGlobalSearch } from "@/search/notes/useNoteGlobalSearch";
...
export function NoteGlobalSearch() {
  ...
  const results = useNoteGlobalSearch(notes, views, deferredQuery);
