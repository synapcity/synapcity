...
const MarqueeScroller = dynamic(() => import("@/landing-page/components").then((mod) => mod.MarqueeScroller), { ssr: true })
const Framer = dynamic(() => import("react-icons/si").then((mod) => mod.SiFramer), { ssr: true })
const Nextjs = dynamic(() => import("react-icons/si").then((mod) => mod.SiNextdotjs), { ssr: true })
const TypeScript = dynamic(() => import("react-icons/si").then((mod) => mod.SiTypescript), { ssr: true })
const TailwindCSS = dynamic(() => import("react-icons/si").then((mod) => mod.SiTailwindcss), { ssr: true })
const PostgreSQL = dynamic(() => import("react-icons/si").then((mod) => mod.SiPostgresql), { ssr: true })
const Prisma = dynamic(() => import("react-icons/si").then((mod) => mod.SiPrisma), { ssr: true })
const Supabase = dynamic(() => import("react-icons/si").then((mod) => mod.SiSupabase), { ssr: true })
const Shadcnui = dynamic(() => import("react-icons/si").then((mod) => mod.SiShadcnui), { ssr: true })
