...
export type MetadataStore = MetadataSlice & SelectionSlice & StatusSlice & HydrationSlice;

export const metadataStoreInitializer: StateCreator<MetadataStore> = (set, get, store) => ({
  language: "en",
  themeMode: "light",
