...
const GeneralTab = dynamic(
  () => import("./Tabs/GeneralTab/GeneralTab").then((mod) => mod.GeneralTab),
  { ssr: false }
);
const FontsTab = dynamic(() => import("./Tabs/FontsTab/FontsTab").then((mod) => mod.FontsTab), {
  ssr: false,
});
const ColorsTab = dynamic(() => import("./Tabs/ColorsTab/ColorsTab").then((mod) => mod.ColorsTab), {
  ssr: false,
});
const PreviewTab = dynamic(
  () => import("./Tabs/PreviewTab/PreviewTab").then((mod) => mod.PreviewTab),
  { ssr: false }
);
