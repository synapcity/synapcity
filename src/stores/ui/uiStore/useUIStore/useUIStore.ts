...
import { createSelectionSlice, createHydrationSlice, createStatusSlice } from "@/stores/slices";
import type { HydrationSlice, StatusSlice, SelectionSlice } from "@/stores/slices";
...
export type UIStore = UIState & UIActions & SelectionSlice & StatusSlice & HydrationSlice;
