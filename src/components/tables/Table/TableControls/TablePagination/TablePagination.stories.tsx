...
const metaPag: Meta<typeof TablePagination> = { title: 'Table/TablePagination', component: TablePagination, tags: ['autodocs'] };
...
const makeTable = (canPrev: boolean, canNext: boolean, pageIndex: number, pageCount: number) => ({
  previousPage: () => { }, nextPage: () => { }, getCanPreviousPage: () => canPrev, getCanNextPage: () => canNext,
  getState: () => ({ pagination: { pageIndex } }), getPageCount: () => pageCount,
