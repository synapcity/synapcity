const nodeMap = {
	HeadingNode: () =>
		import("@lexical/rich-text").then((mod) => mod.HeadingNode),
	...
	HorizontalRuleNode: () =>
		import("@lexical/react/LexicalHorizontalRuleNode").then(
			(mod) => mod.HorizontalRuleNode
		),
	...
	TableCellNode: () =>
		import("@lexical/table").then((mod) => mod.TableCellNode),
