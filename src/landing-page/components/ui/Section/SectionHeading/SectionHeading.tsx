...
const MotionHeading = dynamic(() => import("@/landing-page/components/ui/Motion").then((mod) => mod.MotionH2), { ssr: true })
...
export const SectionHeading = ({ display, center, left, children, animated, icon, iconClasses, badge, size = "md", badgeClasses, className, ...props }: SectionHeadingProps & BaseProps) => {
