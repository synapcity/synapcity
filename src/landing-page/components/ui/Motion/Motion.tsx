...
export const MotionDiv = ({ children, ...props }: MotionWrapperProps & { ref?: React.Ref<HTMLDivElement> }) => {
  return (
    <motion.div
      {...props}
    >
...
export const MotionP = ({ children, ...props }: Omit<MotionWrapperProps, "whileTap" | "whileHover"> & { ref?: React.Ref<HTMLParagraphElement> }) => {
  return (
    <motion.p
      {...props}
    >
...
export const MotionButton = ({ children, ...props }: MotionWrapperProps & { ref?: React.Ref<HTMLButtonElement> }) => {
  return (
    <motion.button
      {...props}
    >
...
export const MotionH2 = ({ children, ...props }: MotionWrapperProps & { ref?: React.Ref<HTMLHeadingElement> }) => {
  return (
    <motion.h2
      {...props}
    >
