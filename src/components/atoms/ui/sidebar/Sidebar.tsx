...
// const SIDEBAR_WIDTH_MOBILE = 320 // px ("20rem")
// const SIDEBAR_WIDTH_DEFAULT = 320 // px
// const SIDEBAR_WIDTH_MIN = 320     // px
// const SIDEBAR_WIDTH_MAX = 480
// const SIDEBAR_WIDTH_LS_KEY = "sidebarWidth" // localStorage key
...
//   // ----- Collapsible NONE: always shown, not toggleable -----
//   if (collapsible === "none") {
//     return (
//       <div
//         data-slot="sidebar"
//         className={cn(
//           "text-[var(--sidebar-foreground)] flex h-full w-[var(--sidebar-width)] flex-col",
//           className
//         )}
//         {...props}
//       >
...
//   // ----- Mobile view uses Sheet (Drawer) UI -----
//   if (isMobile) {
//     return (
...
//   // ----- CONTAINER/inset VARIANT: Responsive to parent, resizable if set -----
//   if (variant === "container" || variant === "inset") {
//     return (
//       <div
//         className={cn(
//           "relative h-full flex flex-col max-h-full group z-10",
//           className
//         )}
//         style={{
//           width: resizable ? sidebarWidth : undefined,
//           minWidth: resizable ? SIDEBAR_WIDTH_MIN : undefined,
//           maxWidth: resizable ? SIDEBAR_WIDTH_MAX : undefined,
//         }}
//         data-state={state}
...
//   // ----- All other variants ("sidebar", "floating", etc) -----
//   return (
//     <div
