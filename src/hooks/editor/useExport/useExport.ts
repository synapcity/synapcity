...
// 	return { format, setFormat, loading, formats, triggerRef, onStartExport };
// }
...
export function useExport({
	...
	const allFormats: Format[] = exportFormats ?? [
		"csv",
		"json",
		"xlsx",
		"pdf",
	...
	const availableFormats: Format[] =
		exportAs === "document"
			? allFormats.filter((f) => f === "pdf" || f === "txt")
			: allFormats;
	...
	}, [availableFormats, exportAs, format]); // or [availableFormats]
