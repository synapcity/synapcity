...
const DashboardLayout = dynamic(() => import("./DashboardLayout"), {
  ssr: true,
  loading: ({ isLoading }) => <SkeletonOrLoading isLoading={isLoading} />,
});
export default async function DashboardShowLayout({
  children,
  params,
}: {
  ...
  return (
    <DashboardShowProviders dashboardId={dashboardId}>
      <DashboardLayout dashboardId={dashboardId}>{children}</DashboardLayout>
