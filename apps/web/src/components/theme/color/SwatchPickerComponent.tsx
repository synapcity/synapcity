...
const SwatchPickerComponent: React.FC<SwatchPickerComponentProps> = ({ value, onChange }) => {
  ...
  const color = sketchState.color.rgb
    ? `rgba(${sketchState.color.rgb.r}, ${sketchState.color.rgb.g}, ${sketchState.color.rgb.b}, ${sketchState.color.rgb.a})`
    : value;
