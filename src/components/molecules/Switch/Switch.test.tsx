...
describe("Switch", () => {
  ...
  it("calls onCheckedChange when toggled (uncontrolled)", () => {
    ...
    render(<Switch label="Auto Save" defaultChecked={false} onCheckedChange={handleChange} />);
  ...
  it("applies custom className and ID", () => {
    render(<Switch label="Custom" className="custom-class" id="custom-id" defaultChecked />);
    const toggle = screen.getByRole("switch");
